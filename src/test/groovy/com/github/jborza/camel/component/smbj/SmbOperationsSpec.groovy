...
class SmbOperationsSpec extends Specification {
    ...
    def "listFiles should invoke listFiles on client"() {
        ...
        then:
        1 * mockSmbClient.doListFiles("directory")
    }
    ...
    def "deleteFile should invoke deleteFile on client"() {
        ...
        then:
        1 * mockSmbClient.doDeleteFile("path/to/file")
    }
    ...
    def "existsFile test"() {
        ...
        then:
        1 * mockSmbClient.doFileExists("path/to/some/file")
    }
    ...
    def "storeFile test with InputStream"() {
        ...
        //getIn should return the body exchange.
        when:
        ops.storeFile("name", exchange)
        then:
        1 * mockSmbClient.doStoreFile("name", !null)
    }
    ...
    def "renameFile test"() {
        ...
        then:
        1 * mockSmbClient.doRenameFile("directory/source_file.ext", "directory/target_file.ext")
    }
}